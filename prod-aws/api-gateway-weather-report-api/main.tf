...
resource "aws_iam_role" "apigw_cloudwatch" {
  name = "weather-report-api-apigw-cw-role"
...
resource "aws_cloudwatch_log_group" "apigw" {
  name              = "/aws/apigateway/weather-report-api"
...
resource "aws_api_gateway_rest_api" "this" {
  name        = "weather-report-api"
  description = "weather-report-api REST API managed by OpenClaw"
  tags        = local.tags
...
resource "aws_api_gateway_client_certificate" "this" {
  description = "Client certificate for weather-report-api stage prod"
  tags        = local.tags
}
